<script>
    ...
    const searchList = require('./SearchList.vue');
        ...
        methods: {
            ...
            startGetJuniorHumanListTask: function () {
                ...
                if (!lastItem || !lastItem.isUnit) {
                    ...
                    requestParams.functionName = "mi/salelog/common/getHumanListBySaleLogRight";
                } else {
                    requestParams.params = {
            ...
            saveFocus () {
                ...
                http.ajax({
                    ...
                    params: {
                        humanID: gData.humanID,
                        concernTypeID: sysConfig.concernType.SALELOG_HUMAN,
                            ...
                            <div class="row">
                                ...
                                <div class="col col-center">
                                    <div class="row">
                                        ...
                                        <i class="col-center focusSelect icon-ok iconSelect"
                                           v-show="!human.isUnit && selectHumans[human.humanID]"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
