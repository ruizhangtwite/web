            ...
            <div class="item" style="margin-top:5px">
                <div class="row">
                    ...
                    <div class="col" style="margin-left: 5px">
                        <div class="patrolName" style="color:#37AEFF;font-size: 16px;margin-top: 3px">{{obj.n}}</div>
                        <div class="patrolID" style="color:#a3a3a3;font-size: 12px;margin-top: 3px">工卡号：{{obj.id}}</div>
                        <div class="unit" style="color:#ff6100;font-size:12px;margin-top: 3px">{{obj.d}}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default{
        ...
        methods: {
            loadPersonData(isRefresh){
                ...
                if (true){
                    http.ajax({
                        functionName: "getRenMonitorData_ZX",
                        params: {
                            type: this.type,
                            patroType: "11",
